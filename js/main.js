	...
	let errorMsg = function(msg, timer){
		...
		formInput.style.borderColor = "salmon";
		formInput.nextElementSibling.style.background = "salmon";
		formInput.nextElementSibling.style.borderColor = "salmon";

		delay(function(){
			error.innerHTML = "&nbsp;";
			formInput.style.borderColor = "#5a5a5a";
			formInput.nextElementSibling.style.background = "#5a5a5a";
			formInput.nextElementSibling.style.borderColor = "##5a5a5a";
		}, timer);
	}